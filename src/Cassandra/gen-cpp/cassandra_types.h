...
typedef struct _KsDef__isset {
  _KsDef__isset() : strategy_options(false), replication_factor(false) {}
...
class KsDef {
 public:
  ...
  static const char* ascii_fingerprint; // = "0FC5E407EE345529C1ADA19630AAFBA5";
  static const uint8_t binary_fingerprint[16]; // = {0x0F,0xC5,0xE4,0x07,0xEE,0x34,0x55,0x29,0xC1,0xAD,0xA1,0x96,0x30,0xAA,0xFB,0xA5};
